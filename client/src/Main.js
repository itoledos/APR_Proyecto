...
import LogoAPR from "./components/LogoAPR";
// REACT BOOTSTRAP
...
const Main = (props) => {
    ...
    return(
        <React.Fragment>
            <Container 
                className=' d-flex flex-column justify-content-end align-items-center mb-0'>

                <Nav 
                    className="w-75 d-flex flex-column mt-2 mb-0"
                    style={{height: '10vh'}} 
                    // justify 
                    variant="pills" 
                    ...
                    <Row>
                        ...
                        <Col xs={2} className='d-flex flex-column align-items-center'>
                            ...
                            {/* <Nav.Item>
                                <Nav.Link eventKey="link-1">Descarga tu Boleta</Nav.Link>
                            </Nav.Item> */}
                            {/* <Nav.Item>
                ...
                <Container as={Col}
                    className='d-flex flex-wrap align-items-start justify-content-center w-100 mt-5' 
                    style={{
                        height: '84vh',
                    }}
                    >
                    ...
                    >
                        <Card 
                            ...
                            <IconContext.Provider  value={{ size: "6em", color: "#1BAFFF", className: "global-class-name" }}>
                                <RiNumbersLine/>
                    ...
                    <div className="custom-shape-divider-bottom-1663423624">
